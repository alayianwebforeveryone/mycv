      ...
      <div class="flex flex-col md:flex-row px-8 md:px-4 justify-center gap-16 mt-24  pt-20">
        ...
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <div className="flex flex-col items-center pb-6">
            ...
            <div className="flex mt-4 md:mt-6">
              <Link href="https://essay-writing-services-7yaf.vercel.app/" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Vist</Link>
            </div>
          </div>
        </div>
